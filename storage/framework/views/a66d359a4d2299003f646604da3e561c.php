...
<head>
    ...
    <title>Super Admin Login - TheNexZen</title>
            ...
            <div class="col-md-6">
                <div class="fixed_position">
                    <div class="card">
                        ...
                        <form method="POST" action="<?php echo e(route('super-admin.login')); ?>" id="loginForm">
                            <?php echo csrf_field(); ?>
                        ...
                        <div class="register" style="text-align:center ">
                            <p>
                                <a href="<?php echo e(route('business.login')); ?>">Business Login</a>
                            </p>
                            <p>
...
</html><?php /**PATH C:\xampp 8.2\htdocs\nexzen\resources\views/super-admin/auth/login.blade.php ENDPATH**/ ?>