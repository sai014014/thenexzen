                    ...
                    <div class="col-lg-6 col-md-6 mb-4">
                        <div class="card h-100 border-0 shadow-sm">
                            <div class="card-body text-center">
                                ...
                                <a href="<?php echo e(route('business.reports.customer')); ?>" class="btn btn-primary">
                    ...
                    <div class="col-lg-6 col-md-6 mb-4">
                        <div class="card h-100 border-0 shadow-sm">
                            <div class="card-body text-center">
                                ...
                                <a href="<?php echo e(route('business.reports.vehicle')); ?>" class="btn btn-success">
                                    <i class="fas fa-eye me-2"></i>View Report
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6 mb-4">
                        <div class="card h-100 border-0 shadow-sm">
                            <div class="card-body text-center">
                                ...
                                <a href="<?php echo e(route('business.reports.vendor')); ?>" class="btn btn-warning">
                                    <i class="fas fa-eye me-2"></i>View Report
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6 mb-4">
                        <div class="card h-100 border-0 shadow-sm">
                            <div class="card-body text-center">
                                ...
                                <a href="<?php echo e(route('business.reports.booking')); ?>" class="btn btn-info">
                                    <i class="fas fa-eye me-2"></i>View Report
                                </a>
                            </div>
                        </div>
                                ...
                                <div class="row text-center">
                                    <div class="col-md-3 mb-3">
                                        <div class="border rounded p-3">
                                            <h4 class="text-primary mb-1"><?php echo e($business->customers()->count()); ?></h4>
                                            <small class="text-muted">Total Customers</small>
                                        </div>
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        <div class="border rounded p-3">
                                            <h4 class="text-success mb-1"><?php echo e($business->vehicles()->count()); ?></h4>
                                            <small class="text-muted">Total Vehicles</small>
                                        </div>
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        <div class="border rounded p-3">
                                            <h4 class="text-warning mb-1"><?php echo e($business->vendors()->count()); ?></h4>
                                            <small class="text-muted">Total Vendors</small>
                                        </div>
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        <div class="border rounded p-3">
                                            <h4 class="text-info mb-1"><?php echo e($business->bookings()->count()); ?></h4>
