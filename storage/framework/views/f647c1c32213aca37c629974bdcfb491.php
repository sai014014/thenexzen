...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'The NexZen - Super Admin'); ?></title>
...
<body>
            ...
            <nav class="col-md-3 col-lg-2 d-md-block sidebar">
                <div class="position-sticky pt-3">
                    ...
                    <a class="nav-link <?php echo e(request()->routeIs('super-admin.dashboard') ? 'active' : ''); ?>" href="<?php echo e(route('super-admin.dashboard')); ?>">
                        ...
                        <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->routeIs('super-admin.businesses.*') ? 'active' : ''); ?>" href="<?php echo e(route('super-admin.businesses.index')); ?>">
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    ...
                    <div class="btn-toolbar mb-2 mb-md-0">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="<?php echo e(route('super-admin.dashboard')); ?>">
                                    <i class="fas fa-user-cog me-2"></i>Profile
                                </a></li>
                                <li><a class="dropdown-item" href="<?php echo e(route('super-admin.bugs.index')); ?>">
    ...
    <script>
        function clearAllCache() {
            ...
            fetch('<?php echo e(route("super-admin.cache.clear")); ?>', {
                method: 'POST',
                headers: {
        ...
        function getMigrationStatus() {
            ...
            fetch('<?php echo e(route("super-admin.migrations.status")); ?>', {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
        ...
        function runMigrations() {
            ...
            fetch('<?php echo e(route("super-admin.migrations.run")); ?>', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
        ...
        function syncMigrations() {
            ...
            fetch('<?php echo e(route("super-admin.migrations.sync")); ?>', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
        ...
        function rollbackMigrations() {
            ...
            fetch('<?php echo e(route("super-admin.migrations.rollback")); ?>', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
        ...
        function resetMigrations() {
            ...
            fetch('<?php echo e(route("super-admin.migrations.reset")); ?>', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
...
</html><?php /**PATH C:\xampp 8.2\htdocs\nexzen\resources\views/super-admin/layouts/app.blade.php ENDPATH**/ ?>