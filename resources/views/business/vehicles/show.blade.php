    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <a href="{{ route('business.vehicles.index') }}" class="btn btn-link text-decoration-none">
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex gap-3">
                        <a href="{{ route('business.vehicles.edit', $vehicle) }}" class="btn btn-link text-muted text-decoration-none">
                            Edit
                        </a>
                        <button class="btn btn-link text-danger text-decoration-none" onclick="confirmDelete({{ $vehicle->id }})">
                            Delete
                        </button>
                        <a href="{{ route('business.bookings.create', ['vehicle_id' => $vehicle->id]) }}" class="btn btn-primary px-4">
                            Book
                        </a>
                    </div>
                </div>
                ...
                <div class="card-header">
                    <h6 class="mb-0">
                        ...
                        @if($vehicle->images && $vehicle->images->count() > 0)
                            <span class="badge bg-primary ms-2">{{ $vehicle->images->count() }} image(s)</span>
                        @endif
                    </h6>
                </div>
...
function updateStatus(status) {
    ...
    fetch(`/business/vehicles/{{ $vehicle->id }}/toggle-availability`, {
        method: 'POST',
        headers: {
