...
<body>
    ...
    <nav class="sidebar">
        <div class="logo">
            <img src="{{ asset('images/mainLogo.svg') }}" alt="Logo">
    ...
    <header class="header">
                    ...
                    <div class="profile">
                        ...
                        <div class="profile_menu">
                            ...
                            <div class="dropdown-menu" id="dropdownMenu">
                                <a href="{{ route('business.dashboard') }}" class="menu-item manage-account">Manage Account</a>
        ...
        <img class="border_bg" src="{{ asset('images/header_bg.svg') }}" alt="Logo">
    </header>
