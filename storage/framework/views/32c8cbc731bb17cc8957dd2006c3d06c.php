...
<head>
    ...
    <title>Business Login - TheNexZen</title>
            ...
            <div class="col-md-6">
                <div class="fixed_position">
                    <div class="card">
                        ...
                        <form method="POST" action="<?php echo e(route('business.login')); ?>" id="loginForm">
                            <?php echo csrf_field(); ?>
                            <label for="email">Email address</label>
                            <input class="loginInput" type="email" id="email" name="email" value="<?php echo e(old('email')); ?>" required>

                            <label for="password">Password:</label>
                            <input class="loginInput" type="password" id="password" name="password" required>
                            <div style="text-align: right; margin-top: -10px; margin-bottom: 15px;">
                                <a href="<?php echo e(route('business.password.request')); ?>" style="color: #6B6ADE; text-decoration: none; font-size: 14px;">Forgot Password?</a>
                            </div>
                            <button class="submit loginSubmit" type="submit">Log in</button>
                        </form>
                        <div class="register" style="text-align:center ">
                            <p>
                                <a href="<?php echo e(route('business.register')); ?>">Register New Business</a>
                            </p>
                            <p>
...
</html><?php /**PATH C:\xampp 8.2\htdocs\nexzen\resources\views/business/auth/login.blade.php ENDPATH**/ ?>