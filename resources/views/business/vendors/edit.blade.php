                ...
                <form id="vendorForm" method="POST" action="{{ route('business.vendors.update', $vendor) }}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="pan_number" name="pan_number" value="{{ old('pan_number', $vendor->pan_number) }}" maxlength="10" required>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            @if($vendor->additional_certificates && count($vendor->additional_certificates) > 0)
                                <div class="mt-2">
                                    <small class="text-muted">Current certificates: {{ count($vendor->additional_certificates) }}</small>
                                </div>
                            @endif
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="d-flex justify-content-end gap-2">
                                <a href="{{ route('business.vendors.show', $vendor) }}" class="btn btn-secondary">
