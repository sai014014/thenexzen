    ...
    <table id="vendorTable" class="table table-striped table-bordered">
        ...
        <tbody id="vendorTableBody">
            ...
            <tr>
                <td class="vendor_title">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="brand-icon-placeholder me-2 d-flex align-items-center justify-content-center vendor-color-badge" 
                             style="width: 30px; height: 30px; background: <?php echo e($vendorColor); ?>; color: white; border-radius: 4px; font-size: 12px; font-weight: bold;">
                            <?php echo e(strtoupper(substr($vendor->vendor_name, 0, 2))); ?>

                        </div>
                        <div>
                            <div class="fw-bold"><?php echo e($vendor->vendor_name); ?></div>
                            <small class="text-muted"><?php echo e($vendor->mobile_number); ?></small>
                        </div>
                    </div>
                </td>
                <td>
                ...
                <td>
                    <a href="<?php echo e(route('business.vendors.show', $vendor)); ?>" class="text-primary text-decoration-none" style="font-weight: 500;">View</a>
                </td>
            </tr>
