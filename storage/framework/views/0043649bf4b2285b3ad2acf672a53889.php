    ...
    <div class="stats-card">
        <div class="stats-content">
            <div class="stats-info">
                ...
                <div class="stats-value">₹<?php echo e(number_format($totalEarnings ?? 0)); ?></div>
                <div class="stats-change <?php echo e(($earningsChange ?? 0) >= 0 ? 'positive' : 'negative'); ?>">
                    <i class="fas fa-arrow-<?php echo e(($earningsChange ?? 0) >= 0 ? 'up' : 'down'); ?>"></i>
                    <span><?php echo e(abs($earningsChange ?? 0)); ?>% <?php echo e(($earningsChange ?? 0) >= 0 ? 'Up' : 'Down'); ?> from yesterday</span>
                </div>
            </div>
    ...
    <div class="stats-card">
        <div class="stats-content">
            <div class="stats-info">
                ...
                <div class="stats-value"><?php echo e($totalBookings ?? 0); ?></div>
                <div class="stats-change <?php echo e(($bookingsChange ?? 0) >= 0 ? 'positive' : 'negative'); ?>">
                    <i class="fas fa-arrow-<?php echo e(($bookingsChange ?? 0) >= 0 ? 'up' : 'down'); ?>"></i>
                    <span><?php echo e(abs($bookingsChange ?? 0)); ?>% <?php echo e(($bookingsChange ?? 0) >= 0 ? 'Up' : 'Down'); ?> from yesterday</span>
                </div>
            </div>
    ...
    <div class="stats-card">
        <div class="stats-content">
            <div class="stats-info">
                ...
                <div class="stats-value"><?php echo e($totalVendors ?? 0); ?></div>
                <div class="stats-change <?php echo e(($vendorsChange ?? 0) >= 0 ? 'positive' : 'negative'); ?>">
                    <i class="fas fa-arrow-<?php echo e(($vendorsChange ?? 0) >= 0 ? 'up' : 'down'); ?>"></i>
                    <span><?php echo e(abs($vendorsChange ?? 0)); ?>% <?php echo e(($vendorsChange ?? 0) >= 0 ? 'Up' : 'Down'); ?> from yesterday</span>
                </div>
            </div>
    ...
    <div class="stats-card">
        <div class="stats-content">
            <div class="stats-info">
                ...
                <div class="stats-value"><?php echo e($totalVehicles ?? 0); ?></div>
                <div class="stats-change <?php echo e(($vehiclesChange ?? 0) >= 0 ? 'positive' : 'negative'); ?>">
                    <i class="fas fa-arrow-<?php echo e(($vehiclesChange ?? 0) >= 0 ? 'up' : 'down'); ?>"></i>
                    <span><?php echo e(abs($vehiclesChange ?? 0)); ?>% <?php echo e(($vehiclesChange ?? 0) >= 0 ? 'Up' : 'Down'); ?> from yesterday</span>
                </div>
            </div>
    ...
    <div class="stats-card">
        <div class="stats-content">
            <div class="stats-info">
                ...
                <div class="stats-value"><?php echo e($totalCustomers ?? 0); ?></div>
                <div class="stats-change <?php echo e(($customersChange ?? 0) >= 0 ? 'positive' : 'negative'); ?>">
                    <i class="fas fa-arrow-<?php echo e(($customersChange ?? 0) >= 0 ? 'up' : 'down'); ?>"></i>
                    <span><?php echo e(abs($customersChange ?? 0)); ?>% <?php echo e(($customersChange ?? 0) >= 0 ? 'Up' : 'Down'); ?> from yesterday</span>
                </div>
            </div>
    ...
    <div class="table-container">
                            ...
                            <td>
                                <div class="vehicle-info">
                                    ...
                                    <div class="vehicle-details">
                                        <div class="vehicle-name"><?php echo e($booking->vehicle->vehicle_make ?? 'N/A'); ?> <?php echo e($booking->vehicle->vehicle_model ?? ''); ?></div>
                                        <div class="vehicle-number"><?php echo e($booking->vehicle->vehicle_number ?? 'N/A'); ?></div>
                                    </div>
                                </div>
                            </td>
        ...
        <?php else: ?>
            <div class="no-data-message">
                ...
                <a href="<?php echo e(route('business.bookings.create')); ?>" class="btn btn-primary">Create First Booking</a>
            </div>
        <?php endif; ?>
    </div>
</div>
