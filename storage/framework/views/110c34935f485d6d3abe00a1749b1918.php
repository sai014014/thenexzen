...
<div class="booking-flow-container">
    ...
    <div class="booking-flow-header">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <a href="<?php echo e(route('business.bookings.index')); ?>" class="back-link">
    ...
    <div class="booking-flow-content">
        <div class="container">
            <form id="bookingForm" method="POST" action="<?php echo e(route('business.bookings.store')); ?>">
                <?php echo csrf_field(); ?>
                                ...
                                <div class="card-body">
                                    ...
                                    <div id="customerSelection">
                                        <div class="text-center py-4">
                                            ...
                                            <a href="<?php echo e(route('business.customers.create')); ?>" class="btn btn-outline-primary" target="_blank">
...
function loadVehicles() {
    ...
    const apiUrl = `<?php echo e(url('business/api/vehicles/available')); ?>?start_date=${startDate}&start_time=${startTime}&end_date=${endDate}&end_time=${endTime}`;
...
function initializeCustomerSearch() {
    ...
    searchInput.addEventListener('input', function() {
        ...
        fetch(`<?php echo e(url('business/api/customers/search')); ?>?q=${encodeURIComponent(query)}`, {
            method: 'GET',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json',
...
<?php echo $__env->make('business.layouts.booking-flow', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp 8.2\htdocs\nexzen\resources\views/business/bookings/flow/create.blade.php ENDPATH**/ ?>