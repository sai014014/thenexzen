...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <?php for($i = 1; $i <= 20; $i++): ?>
                                        <option value="<?php echo e($i); ?>" <?php echo e(old('seating_capacity') == $i ? 'selected' : ''); ?>><?php echo e($i); ?></option>
                                    <?php endfor; ?>
                                </select>
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <option value="">Select Seating Capacity</option>
                                    <?php for($i = 1; $i <= 100; $i++): ?>
                                        <option value="<?php echo e($i); ?>" <?php echo e(old('seating_capacity_heavy') == $i ? 'selected' : ''); ?>><?php echo e($i); ?></option>
                                    <?php endfor; ?>
                                </select>
