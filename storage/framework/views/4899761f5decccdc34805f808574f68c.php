        ...
        <div class="d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center">
                ...
                <div>
                    ...
                    <h2 class="mb-0 fw-bold"><?php echo e($vendor->vendor_name); ?></h2>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <form id="delete-vendor-form" action="<?php echo e(route('business.vendors.destroy', $vendor)); ?>" method="POST" style="display: inline;">
                                    <?php echo csrf_field(); ?>
