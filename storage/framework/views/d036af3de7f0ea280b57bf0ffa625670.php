                ...
                <div class="row">
                    <?php $__currentLoopData = $availablePackages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-4 mb-3">
                            <div class="package-card h-100" data-package-id="<?php echo e($package->id); ?>">
                                <div class="card h-100">
                                    ...
                                    <div class="card-footer text-center">
                                        <?php if(!$hasSubscriptionHistory): ?>
                                            <button class="btn btn-success btn-sm me-2" onclick="startTrialForPackage(<?php echo e($package->id); ?>)">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="card h-100 border-success">
                                    <div class="card-header bg-light text-center">
                                        <h6 class="mb-0 text-success"><?php echo e($package->package_name); ?></h6>
                                        <h4 class="text-primary mt-2"><?php echo e($package->formatted_price); ?>/month</h4>
                                    </div>
                                    <div class="card-body">
                                        <p class="text-muted small"><?php echo e($package->description); ?></p>
                                        <ul class="list-unstyled small">
                                            <li><i class="fas fa-check text-success me-2"></i><?php echo e($package->vehicle_capacity_display); ?> vehicles</li>
                                            <li><i class="fas fa-check text-success me-2"></i><?php echo e(ucfirst($package->support_type)); ?> support</li>
                                            <li><i class="fas fa-check text-success me-2"></i><?php echo e($package->trial_period_days); ?> days trial</li>
                                        </ul>
                                    </div>
                                    <div class="card-footer text-center">
                                        <button class="btn btn-success w-100" onclick="startTrialForPackage(<?php echo e($package->id); ?>)">
                                            <i class="fas fa-play me-2"></i>Start <?php echo e($package->trial_period_days); ?>-Day Trial
                                        </button>
                                    </div>
                                </div>
                            </div>
