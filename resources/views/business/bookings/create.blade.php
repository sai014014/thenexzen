    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                ...
                <small class="text-muted">Book a vehicle for a customer</small>
            </div>
            <div class="card-body">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="datetime-local" class="form-control" id="start_date_time" name="start_date_time" value="{{ old('start_date_time') }}" required>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="datetime-local" class="form-control" id="end_date_time" name="end_date_time" value="{{ old('end_date_time') }}" required>
                                    @error('end_date_time')
                                        <div class="text-danger small">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="advance_amount" name="advance_amount" value="{{ old('advance_amount') }}" min="0" step="0.01" onchange="calculatePricing()">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select" id="advance_payment_method" name="advance_payment_method">
                                        ...
                                        <option value="credit_card" {{ old('advance_payment_method') == 'credit_card' ? 'selected' : '' }}>Credit Card</option>
                                        <option value="debit_card" {{ old('advance_payment_method') == 'debit_card' ? 'selected' : '' }}>Debit Card</option>
                                        <option value="upi" {{ old('advance_payment_method') == 'upi' ? 'selected' : '' }}>UPI</option>
                                        <option value="bank_transfer" {{ old('advance_payment_method') == 'bank_transfer' ? 'selected' : '' }}>Bank Transfer</option>
                                        <option value="cheque" {{ old('advance_payment_method') == 'cheque' ? 'selected' : '' }}>Cheque</option>
                                    </select>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <textarea class="form-control" id="customer_notes" name="customer_notes" rows="3" placeholder="Any special requests or notes from the customer">{{ old('customer_notes') }}</textarea>
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <textarea class="form-control" id="notes" name="notes" rows="3" placeholder="Internal notes about this booking">{{ old('notes') }}</textarea>
                                    @error('notes')
                                        <div class="text-danger small">{{ $message }}</div>
                                    @enderror
                                </div>
