...
<head>
    ...
    <title>Forgot Password - TheNexZen</title>
                ...
                <div class="fixed_position">
                    <div class="card">
                        ...
                        <form method="POST" action="{{ route('business.password.email') }}">
                            ...
                            <input class="loginInput" type="email" id="email" name="email" value="{{ old('email') }}" required>
                            
                            <button class="submit loginSubmit" type="submit">Send Password Reset Link</button>
                        </form>
                        ...
                        <div class="register" style="text-align:center">
                            ...
                            <p>
                                <a href="{{ route('business.register') }}">Register New Business</a>
                            </p>
                        </div>
                    </div>
                </div>
